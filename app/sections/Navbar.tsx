...
export default function Navbar() {
 ...
 <div className="fixed lg:hidden z-60 bg-[#AD6903]/31 w-full h-auto">
            <div className="w-full h-auto flex items-center justify-between pr-2">
              <Image src="/img/logo.jpg" alt="" width={2481} height={1792} className="w-30 h-auto"/>
              <Menu 
            ...
            >
                <div className="p-2 flex flex-col items-center gap-y-1">
        ...
        <div className="w-full h-auto flex items-center">
             ...
             <div className="flex justify-center items-center w-1/4 gap-2">
                        <button className="px-4 py-2 transition-all duration-300 ease-in-out text-white text-base xl:text-xl font-bold bg-[#A3B310] hover:bg-[#ffffff] hover:text-[#A3B310] cursor-pointer rounded-[10px]">
                            <span>Sign Up</span>
                        </button>
                        <button className="px-4 py-2 transition-all duration-300 ease-in-out text-white text-base xl:text-xl font-bold bg-[#A3B310] hover:bg-[#ffffff] hover:text-[#A3B310] cursor-pointer rounded-[10px]">
                            <span>Log In</span>
